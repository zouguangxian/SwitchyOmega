...
angular.module('omegaDecoration', [])
  .value('profileIcons', {
  ...
  .directive('omegaProfileIcon', ['profileIcons', 'getVirtualTarget', function(profileIcons: any, getVirtualTarget: any) {
    return {
      restrict: 'A',
      template: `
  ...
  .directive('omegaHtml', ['$compile', function($compile: any) {
    return {
      restrict: 'A',
      link: (scope: any, element: any, attrs: any) => {
        const locals = {
  ...
  .directive('omegaProfileSelect', ['$timeout', 'profileIcons', function($timeout: any, profileIcons: any) {
    return {
      restrict: 'A',
      ...
      link: (scope: any, element: any, attrs: any, ngModel: any) => {
        ...
        scope.$watch(scope.profiles, ((profiles: any) => {
