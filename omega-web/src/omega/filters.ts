...
angular.module('omega')
  .filter('profiles', ['builtinProfiles', 'profileOrder', 'isProfileNameHidden', 'isProfileNameReserved', 
    function(builtinProfiles: any, profileOrder: any, isProfileNameHidden: any, isProfileNameReserved: any) {
  ...
  .filter('tr', ['omegaTarget', function(omegaTarget: any) {
    return omegaTarget.getMessage;
  }])
  .filter('dispName', ['omegaTarget', function(omegaTarget: any) {
