...
console.log(
  `Building omega-web (${isWatch ? 'watch' : isProd ? 'production' : 'development'} mode)...`,
);
...
const vendorAssets = [
  {
    label: 'angular-loader',
    src: 'bower_components/angular-loader/angular-loader.min.js',
    dest: path.join(buildDir, 'lib', 'angular-loader', 'angular-loader.min.js'),
  },
  {
    label: 'angular',
    src: 'bower_components/angular/angular.min.js',
    dest: path.join(buildDir, 'lib', 'angular', 'angular.min.js'),
  },
  {
    label: 'angular-animate',
    src: 'bower_components/angular-animate/angular-animate.min.js',
    dest: path.join(buildDir, 'lib', 'angular-animate', 'angular-animate.min.js'),
  },
  {
    label: 'angular-sanitize',
    src: 'bower_components/angular-sanitize/angular-sanitize.min.js',
    dest: path.join(buildDir, 'lib', 'angular-sanitize', 'angular-sanitize.min.js'),
  },
  {
    label: 'angular-bootstrap',
    src: 'bower_components/angular-bootstrap/ui-bootstrap-tpls.min.js',
    dest: path.join(buildDir, 'lib', 'angular-bootstrap', 'ui-bootstrap-tpls.min.js'),
  },
  {
    label: 'angular-i18n en-us',
    src: 'bower_components/angular-i18n/angular-locale_en-us.js',
    dest: path.join(buildDir, 'lib', 'angular-i18n', 'angular-locale_en-us.js'),
  },
  {
    label: 'angular-i18n zh-cn',
    src: 'bower_components/angular-i18n/angular-locale_zh-cn.js',
    dest: path.join(buildDir, 'lib', 'angular-i18n', 'angular-locale_zh-cn.js'),
  },
  {
    label: 'angular-i18n zh-hk',
    src: 'bower_components/angular-i18n/angular-locale_zh-hk.js',
    dest: path.join(buildDir, 'lib', 'angular-i18n', 'angular-locale_zh-hk.js'),
  },
  {
    label: 'angular-i18n zh-tw',
    src: 'bower_components/angular-i18n/angular-locale_zh-tw.js',
    dest: path.join(buildDir, 'lib', 'angular-i18n', 'angular-locale_zh-tw.js'),
  },
  {
    label: 'angular-ladda',
    src: 'bower_components/angular-ladda/dist/angular-ladda.min.js',
    dest: path.join(buildDir, 'lib', 'angular-ladda', 'angular-ladda.min.js'),
  },
  {
    label: 'angular-spectrum-colorpicker',
    src: 'bower_components/angular-spectrum-colorpicker/dist/angular-spectrum-colorpicker.min.js',
    dest: path.join(
      buildDir,
      'lib',
  ...
  },
  {
    ...
    dest: path.join(buildDir, 'lib', 'angular-ui-router', 'angular-ui-router.min.js'),
  },
  {
    label: 'angular-ui-router stateEvents',
    src: 'bower_components/angular-ui-router/release/stateEvents.min.js',
    dest: path.join(buildDir, 'lib', 'angular-ui-router', 'stateEvents.min.js'),
  },
  {
    label: 'angular-ui-sortable',
    src: 'bower_components/angular-ui-sortable/sortable.min.js',
    dest: path.join(buildDir, 'lib', 'angular-ui-sortable', 'sortable.min.js'),
  },
  {
    label: 'FileSaver',
    src: 'bower_components/FileSaver/FileSaver.min.js',
    dest: path.join(buildDir, 'lib', 'FileSaver', 'FileSaver.min.js'),
  },
  {
    label: 'blob',
    src: 'bower_components/blob/Blob.js',
    dest: path.join(buildDir, 'lib', 'blob', 'Blob.js'),
  },
  {
    label: 'jquery',
    src: 'bower_components/jquery/dist/jquery.min.js',
    dest: path.join(buildDir, 'lib', 'jquery', 'jquery.min.js'),
  },
  {
    label: 'jqueryui-touch-punch',
    src: 'bower_components/jqueryui-touch-punch/jquery.ui.touch-punch.min.js',
    dest: path.join(buildDir, 'lib', 'jqueryui-touch-punch', 'jquery.ui.touch-punch.min.js'),
  },
  {
    label: 'ngprogress',
    src: 'bower_components/ngprogress/build/ngProgress.min.js',
    dest: path.join(buildDir, 'lib', 'ngprogress', 'ngProgress.min.js'),
  },
  {
    label: 'spectrum js',
    src: 'bower_components/spectrum/spectrum.js',
    dest: path.join(buildDir, 'lib', 'spectrum', 'spectrum.js'),
  },
  {
    label: 'spectrum css',
    src: 'bower_components/spectrum/spectrum.css',
    dest: path.join(buildDir, 'lib', 'spectrum', 'spectrum.css'),
  },
  {
    label: 'shepherd.js',
    src: 'bower_components/shepherd.js/shepherd.min.js',
    dest: path.join(buildDir, 'lib', 'shepherd.js', 'shepherd.min.js'),
  },
  {
    label: 'shepherd.css',
    src: 'bower_components/shepherd.js/css/shepherd-theme-arrows.css',
    dest: path.join(buildDir, 'lib', 'shepherd.js', 'shepherd-theme-arrows.css'),
  },
  {
    label: 'tether',
  ...
  },
  {
    ...
    dest: path.join(buildDir, 'lib', 'bootstrap', 'css', 'bootstrap.min.css'),
  },
  {
    label: 'bootstrap font eot',
    src: 'bower_components/bootstrap/dist/fonts/glyphicons-halflings-regular.eot',
    dest: path.join(buildDir, 'lib', 'bootstrap', 'fonts', 'glyphicons-halflings-regular.eot'),
  },
  {
    label: 'bootstrap font woff2',
    src: 'bower_components/bootstrap/dist/fonts/glyphicons-halflings-regular.woff2',
    dest: path.join(buildDir, 'lib', 'bootstrap', 'fonts', 'glyphicons-halflings-regular.woff2'),
  },
  {
    label: 'bootstrap font woff',
    src: 'bower_components/bootstrap/dist/fonts/glyphicons-halflings-regular.woff',
    dest: path.join(buildDir, 'lib', 'bootstrap', 'fonts', 'glyphicons-halflings-regular.woff'),
  },
  {
    label: 'bootstrap font ttf',
    src: 'bower_components/bootstrap/dist/fonts/glyphicons-halflings-regular.ttf',
    dest: path.join(buildDir, 'lib', 'bootstrap', 'fonts', 'glyphicons-halflings-regular.ttf'),
  },
  {
    label: 'bootstrap font svg',
    src: 'bower_components/bootstrap/dist/fonts/glyphicons-halflings-regular.svg',
    dest: path.join(buildDir, 'lib', 'bootstrap', 'fonts', 'glyphicons-halflings-regular.svg'),
  },
  {
    label: 'ladda css',
    src: 'node_modules/ladda/dist/ladda-themeless.min.css',
    dest: path.join(buildDir, 'lib', 'ladda', 'ladda-themeless.min.css'),
  },
] as const;
...
function setupAssetWatchers() {
  ...
  chokidar.watch('src/less/**/*.less', { ignoreInitial: true }).on('all', (event, filePath) => {
  ...
  for (const target of staticTargets) {
    ...
    chokidar.watch(target.watch, { ignoreInitial: true }).on('all', (event, filePath) => {
  ...
  for (const vendor of [...vendorFiles, ...vendorAssets]) {
    chokidar.watch(vendor.src, { ignoreInitial: true }).on('all', (event) => {
  ...
  chokidar.watch('node_modules/spin.js/**/*.js', { ignoreInitial: true }).on('all', (event) => {
    console.log(`🔁 spin.js change detected (${event})`);
    return vendorQueue(() => bundleSpin());
  });
  chokidar.watch('node_modules/ladda/js/**/*.js', { ignoreInitial: true }).on('all', (event) => {
...
async function createEsbuildContexts() {
  const builds: Array<{ entryPoints: string[]; outfile?: string; outdir?: string }> = [
    ...
    { entryPoints: ['src/coffee/options_guide.ts'], outfile: path.join(jsDir, 'options_guide.js') },
    {
      ...
      outfile: path.join(jsDir, 'switch_profile_guide.js'),
    },
    ...
    { entryPoints: ['src/coffee/log_error.ts'], outfile: path.join(jsDir, 'log_error.js') },
    {
      ...
      outfile: path.join(jsDir, 'omega_decoration.js'),
    },
    {
  ...
  return Promise.all(builds.map((config) => esbuild.context({ ...commonOptions, ...config })));
}
