...
module.exports = exports = {
  ...
  updateUrl: function (profile) {
    var ref2;
    return (ref2 = exports._handler(profile).updateUrl) != null
      ? ref2.call(exports, profile)
      : void 0;
  },
  updateContentTypeHints: function (profile) {
    var ref2;
    return (ref2 = exports._handler(profile).updateContentTypeHints) != null
      ? ref2.call(exports, profile)
      : void 0;
  },
  ...
  allReferenceSet: function (profile, options, opt_args) {
    ...
    if (profile == null) {
      profile =
        typeof exports.profileNotFound === 'function'
          ? exports.profileNotFound(o_profile, opt_args.profileNotFound)
          : void 0;
    }
    if (opt_args == null) {
      opt_args = {};
    ...
    FixedProfile: {
      ...
      match: function (profile, request) {
        ...
        for (j = 0, len1 = ref3.length; j < len1; j++) {
          ...
          if (s.scheme === request.scheme && profile[s.prop]) {
            return [
              ...
              s.scheme,
              profile[s.prop],
              (ref4 = (ref5 = profile.auth) != null ? ref5[s.prop] : void 0) != null
                ? ref4
                : (ref6 = profile.auth) != null
                  ? ref6['all']
                  : void 0,
            ];
          }
        ...
        return [
          ...
          (ref7 = (ref8 = profile.auth) != null ? ref8.fallbackProxy : void 0) != null
            ? ref7
            : (ref9 = profile.auth) != null
              ? ref9['all']
              : void 0,
        ];
      },
    ...
    RuleListProfile: {
      ...
      create: function (profile) {
        ...
        if (profile.format == null) {
          profile.format =
            (ref2 = exports.formatByType[profile.profileType]) != null ? ref2 : 'Switchy';
        }
        if (profile.defaultProfileName == null) {
          profile.defaultProfileName = 'direct';
        }
      ...
      directReferenceSet: function (profile) {
        ...
        if (profile.ruleList != null) {
          refs =
            (ref2 = RuleList[profile.format]) != null
              ? typeof ref2.directReferenceSet === 'function'
                ? ref2.directReferenceSet(profile)
                : void 0
              : void 0;
          if (refs) {
            return refs;
      ...
      update: function (profile, data) {
        ...
        data = data.trim();
        original =
          (ref2 = profile.format) != null ? ref2 : exports.formatByType[profile.profileType];
        profile.profileType = 'RuleListProfile';
        format = original;
        if (
          (typeof (base = RuleList[format]).detect === 'function' ? base.detect(data) : void 0) ===
          false
        ) {
          format = null;
        }
        for (formatName in RuleList) {
          ...
          result =
            typeof (base1 = RuleList[formatName]).detect === 'function'
              ? base1.detect(data)
              : void 0;
